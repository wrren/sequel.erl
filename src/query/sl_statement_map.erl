...
%% public interface
-export([get/2, put/3, start_link/0, stop/0]).
...
handle_call({put, PoolName, Statement, SQL}, _From,
	    State = #state{table = Table}) ->
    {reply, ets:insert(Table, {{PoolName, Statement}, SQL}),
     State};
